...
THREEx.Planets.createSun	= function(){
	...
	var texture	= THREE.ImageUtils.loadTexture('planets/sunmap2.jpg')
...
THREEx.Planets.createMercury	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
	    map: THREE.ImageUtils.loadTexture('planets/mercurymap.jpg'),
	    bumpMap: THREE.ImageUtils.loadTexture('planets/mercurybump.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createVenus	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
	    map: THREE.ImageUtils.loadTexture('planets//venusmap.jpg'),
	    bumpMap: THREE.ImageUtils.loadTexture('planets//venusbump.jpg'),
		bumpScale: 0.005,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createEarth	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
		map		: THREE.ImageUtils.loadTexture('planets/earthmap1k.jpg'),
		bumpMap: THREE.ImageUtils.loadTexture('planets/earthbump1k.jpg'),
		bumpScale	: 0.05,
		specularMap: THREE.ImageUtils.loadTexture('planets/earthspec1k.jpg'),
...
THREEx.Planets.createEarthCloud	= function(){
	...
	imageMap.addEventListener("load", function() {
		...
		imageTrans.src = 'planets/earthcloudmaptrans.jpg';
	}, false);
	imageMap.src	= 'planets/earthcloudmap.jpg';
...
THREEx.Planets.createMars	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
	    map: THREE.ImageUtils.loadTexture('planets/marsmap1k.jpg'),
		bumpMap: THREE.ImageUtils.loadTexture('planets/marsbump1k.jpg'),
		bumpScale: 0.05,
	})
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh	
...
THREEx.Planets.createJupiter	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture = THREE.ImageUtils.loadTexture('planets/jupitermap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.02,
...
THREEx.Planets.createSaturn	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture = THREE.ImageUtils.loadTexture('planets/saturnmap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createSaturnRing	= function(){
	...
	imageMap.addEventListener("load", function() {
		...
		imageTrans.src = 'planets/saturnringpattern.gif';
	}, false);
	imageMap.src = 'planets/saturnringcolor.jpg';
...
THREEx.Planets.createUranus = function () {
   ...
   // alert("xx");
	...
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture = THREE.ImageUtils.loadTexture('planets/uranusmap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createUranusRing	= function(){
	...
	imageMap.addEventListener("load", function() {
		...
		imageTrans.src	= 'planets/uranusringtrans.gif';
	}, false);
	imageMap.src	= 'planets/uranusringcolour.jpg';
...
THREEx.Planets.createNeptune	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var texture	= THREE.ImageUtils.loadTexture('planets/neptunemap.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 0.05,
...
THREEx.Planets.createPluto	= function(){
	var geometry	= new THREE.SphereGeometry(0.5, 32, 32)
	var material	= new THREE.MeshPhongMaterial({
	    map: THREE.ImageUtils.loadTexture('planets/plutomap1k.jpg'),
...
THREEx.Planets.createStarfield	= function(){
    var texture = THREE.ImageUtils.loadTexture('planets/galaxy_starfield.png')
